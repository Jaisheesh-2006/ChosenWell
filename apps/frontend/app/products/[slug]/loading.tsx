  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        {/* Image skeleton */}
        <div className="aspect-square w-full animate-pulse rounded-2xl bg-gray-200 dark:bg-gray-700" />
        ...
        <div className="space-y-6">
          ...
          {/* Score badge */}
          <div className="h-12 w-32 animate-pulse rounded-full bg-gray-200 dark:bg-gray-700" />
